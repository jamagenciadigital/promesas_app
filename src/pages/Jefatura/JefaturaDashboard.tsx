    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h1 className="text-4xl font-black text-gray-900 dark:text-white uppercase italic tracking-tighter leading-none flex items-center gap-4">
            <Building2 className="text-[var(--primary)]" size={40} /> Jefatura de Escenarios
          </h1>
        ...
        <div className="flex bg-gray-100 dark:bg-white/5 p-1 rounded-2xl border border-gray-200 dark:border-white/10">
          <button 
            ...
            className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest italic transition-all ${activeTab === 'indicators' ? 'bg-[var(--primary)] text-black shadow-lg shadow-[var(--primary-20)]' : 'text-gray-500 hover:text-white'}`}
          >
            <BarChart3 className="inline-flex mr-2" size={14} /> Indicadores
          </button>
          <button 
            onClick={() => setActiveTab('pqrs')}
            className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest italic transition-all ${activeTab === 'pqrs' ? 'bg-[var(--primary)] text-black shadow-lg shadow-[var(--primary-20)]' : 'text-gray-500 hover:text-white'}`}
          >
            <MessageSquare className="inline-flex mr-2" size={14} /> Buzón PQRS
          </button>
          <button 
            onClick={() => setActiveTab('venues')}
            className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest italic transition-all ${activeTab === 'venues' ? 'bg-[var(--primary)] text-black shadow-lg shadow-[var(--primary-20)]' : 'text-gray-500 hover:text-white'}`}
          >
            <MapPin className="inline-flex mr-2" size={14} /> Escenarios
          </button>
          <button 
            onClick={() => setActiveTab('assignments')}
            className={`px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest italic transition-all ${activeTab === 'assignments' ? 'bg-[var(--primary)] text-black shadow-lg shadow-[var(--primary-20)]' : 'text-gray-500 hover:text-white'}`}
          >
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white dark:bg-[#16171b] rounded-[48px] border border-gray-100 dark:border-white/5 p-10">
            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase italic tracking-tighter mb-8 flex items-center gap-3">
              <MessageSquare className="text-[var(--primary)]" /> Gestión de PQRS por Escenario
            </h3>
      ...
      {activeTab === 'pqrs' && (
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#16171b] rounded-[48px] border border-gray-100 dark:border-white/5 p-10">
            <h3 className="text-xl font-black text-gray-900 dark:text-white uppercase italic tracking-tighter mb-8 flex items-center gap-3">
              <MessageSquare className="text-[var(--primary)]" /> Buzón de PQRS Recibidas
            </h3>
            
            <div className="space-y-4">
              {pqrsList.length > 0 ? pqrsList.map(p => (
                <div key={p.id} className="p-6 bg-gray-50 dark:bg-black/20 rounded-[32px] border border-gray-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:border-[var(--primary-30)] transition-all group">
                  ...
                  <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <button 
                      ...
                      className="flex-1 md:flex-none px-6 py-3 bg-white dark:bg-white/5 hover:bg-[var(--primary)] hover:text-black rounded-2xl font-black text-[10px] uppercase italic transition-all"
                    >
                      Gestionar
                    </button>
                  </div>
      ...
      {activeTab === 'assignments' && (
        <div className="bg-white dark:bg-[#16171b] rounded-[48px] border border-gray-100 dark:border-white/5 p-10 space-y-8">
           <div className="flex justify-between items-center">
              ...
              <Button onClick={() => setIsAssignModalOpen(true)} className="bg-[var(--primary)] text-black font-black uppercase italic text-[10px] rounded-xl px-6 h-12">Asignar Nuevo</Button>
           </div>
