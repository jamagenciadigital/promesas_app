        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teams.map((team) => (
            <div 
              ...
              className="group cursor-pointer bg-white dark:bg-[#1e293b]/40 border border-gray-100 dark:border-[#334155] rounded-[32px] overflow-hidden hover:border-[var(--primary)] hover:shadow-2xl hover:shadow-[var(--primary-5)] transition-all duration-300"
            >
              <div className="p-8 space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    <Badge variant="success" className="mb-2 bg-[var(--primary-10)] text-[var(--primary)] border-[var(--primary-20)] px-3 py-1 uppercase text-[10px] font-black tracking-widest">
                  ...
                  <div className="p-3 bg-gray-100 dark:bg-white/5 rounded-2xl group-hover:bg-[var(--primary)] group-hover:text-gray-900 transition-colors">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                    <div className="p-2 bg-gray-100 dark:bg-white/5 rounded-lg"><Hash className="w-4 h-4 text-[var(--primary)]" /></div>
