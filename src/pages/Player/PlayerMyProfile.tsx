    ...
    <div className="space-y-8 animate-in fade-in pb-20 print:bg-white print:pb-0">
      <div className="flex justify-between items-center print:hidden">
        ...
        <div className="flex gap-3">
          <Button 
            ...
            className="bg-club-primary text-black border-0 px-6 rounded-2xl flex items-center gap-2 uppercase font-black italic text-xs h-12 hover:scale-105 transition-transform"
          >
            <User size={16} /> Editar Ficha Técnica
          </Button>
          <Button 
            onClick={handlePrint}
            className="bg-black dark:bg-white text-club-primary dark:text-black border-0 px-6 rounded-2xl flex items-center gap-2 uppercase font-black italic text-xs h-12 hover:scale-105 transition-transform"
          >
      ...
      <div id="ficha-deportista" className="space-y-8 print:m-0 print:p-4">
        ...
        <div className="relative bg-black rounded-[48px] overflow-hidden shadow-2xl print:shadow-none print:rounded-[32px]">
          ...
          <div className="p-8 md:p-12 flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap items-center gap-10 relative z-10">
            ...
            <div className="relative shrink-0">
                <div className="w-48 h-48 md:w-56 md:h-56 rounded-[60px] border-[6px] border-club-primary overflow-hidden bg-gray-900 shadow-2xl print:shadow-none">
                {player.foto_url ? (
                    <img 
            ...
            <div className="flex-1 text-center md:text-left space-y-4">
              <div className="flex flex-wrap justify-center md:justify-start gap-4">
                <Badge className="bg-club-primary text-black border-none font-black italic tracking-widest text-xs uppercase px-4 py-1.5 rounded-full print:bg-club-primary print:text-black">
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white italic uppercase leading-none tracking-tighter">
                ...
                <span className="text-club-primary">{player.apellidos || ''}</span>
              </h1>
              ...
              <div className="pt-4 space-y-4">
                 <div className="flex flex-wrap justify-center md:justify-start gap-3">
                    <div className="flex items-center gap-3 px-6 py-3 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
                       <Trophy className="text-club-primary" size={20} />
                    ...
                    {player.dorsal && (
                        <div className="flex items-center gap-3 px-6 py-3 bg-club-primary/10 border border-club-primary/20 rounded-2xl">
                            <span className="text-3xl font-black text-club-primary italic leading-none">{player.dorsal}</span>
                            <span className="text-[10px] font-black text-club-primary uppercase tracking-tighter leading-tight">Dorsal<br/>Oficial</span>
                        </div>
                    )}
                 </div>
                 ...
                 <div className="flex flex-wrap justify-center md:justify-start gap-6 text-white/60 text-[10px] font-bold uppercase tracking-widest italic">
                    <span className="flex items-center gap-2"><Calendar size={16} className="text-club-primary" /> {player.fecha_nacimiento}</span>
                    <span className="flex items-center gap-2"><Shield size={16} className="text-club-primary" /> {player.eps}</span>
                    <span className="flex items-center gap-2"><MapPin size={16} className="text-club-primary" /> {player.municipio || '---'}</span>
                 </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 print:grid-cols-2">
          ...
          <div className="space-y-8">
            <section className="bg-black text-white p-8 rounded-[40px] shadow-sm space-y-6 print:bg-black print:text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 opacity-10">
                 <TrendingUp size={80} className="text-club-primary" />
              </div>
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-club-primary italic border-b border-white/10 pb-3">Perfil Deportivo</h3>
              <div className="grid grid-cols-2 gap-y-6 gap-x-2 relative z-10">
                <div>
                  ...
                  <p className="text-sm font-black text-club-primary uppercase italic leading-none">{player.posicion?.valor || '---'}</p>
                </div>
                <div>
            ...
            <section className="bg-white dark:bg-[#16171b] p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-white/5 space-y-6 print:border-gray-200">
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-club-primary italic border-b border-gray-100 dark:border-white/5 pb-3">Identidad</h3>
          ...
          <div className="space-y-8">
            <section className="bg-club-primary p-8 rounded-[40px] shadow-sm space-y-6 relative overflow-hidden group print:bg-club-primary">
          ...
          <div className="space-y-8 print:col-span-2 print:grid print:grid-cols-2 print:gap-8 print:space-y-0">
            <section className="bg-gray-900 p-8 rounded-[40px] shadow-xl space-y-6 relative overflow-hidden print:bg-gray-900">
               ...
               <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-club-primary italic border-b border-white/5 pb-3">Residencia</h3>
               <div className="space-y-4 relative z-10">
                 <div>
                 ...
                 <div className="flex flex-wrap gap-2">
                    ...
                    <Badge className="bg-club-primary text-black border-none font-black italic">{player.municipio}</Badge>
                 </div>
               </div>
            </section>
                   ...
                   <>
                     {player.equipo2 && (
                       <div className="flex items-center gap-3 p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5">
                          <Trophy size={18} className="text-club-primary" />
        ...
        {asistencias.length > 0 && (
          <section className="bg-white dark:bg-[#16171b] p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-white/5 space-y-6 print:hidden">
            <div className="flex items-center gap-2 border-b border-gray-100 dark:border-white/5 pb-3">
              <Activity className="w-4 h-4 text-club-primary" />
              <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-club-primary italic">Rendimiento y Desempeño</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {asistencias.map((ast, idx) => (
                <div key={idx} className="p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-transparent hover:border-club-primary/20 transition-all space-y-4">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="p-3 bg-black dark:bg-[#111215] rounded-2xl flex flex-col items-center justify-center min-w-[60px] shadow-lg">
                      <span className="text-xl font-black text-club-primary leading-none">{ast.puntaje_total}%</span>
                    </div>
                  </div>
                      ...
                      {ast.evaluaciones.map((ev: any, i: number) => (
                        <div key={i} className="flex justify-between items-center text-[10px] bg-white dark:bg-[#111215] px-3 py-2 rounded-xl">
                          <span className="font-bold text-gray-500 dark:text-gray-400 uppercase truncate pr-2 flex items-center gap-2">
                             <Target size={10} className="text-club-primary" /> {ev.objetivo}
                          </span>
                  ...
                  {ast.notas && (
                    <div className="p-4 bg-club-primary/5 border border-club-primary/10 rounded-2xl mt-2">
        ...
        {/* Expediente Digital */}
        <section className="bg-white dark:bg-[#16171b] p-8 rounded-[40px] shadow-sm border border-gray-100 dark:border-white/5 space-y-6 print:hidden">
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-club-primary italic border-b border-gray-100 dark:border-white/5 pb-3">Documentación</h3>
            ...
            {[
                ...
                <div key={idx} className="flex items-center justify-between p-5 rounded-3xl bg-gray-50 dark:bg-white/5 group border border-transparent hover:border-club-primary/20 transition-all">
                <div className="flex items-center gap-4">
                    <div className="p-3 bg-white dark:bg-[#111215] rounded-2xl">
                       <FileText className="text-gray-400 group-hover:text-club-primary transition-colors" size={20} />
                    </div>
                    <span className="text-xs font-black uppercase text-gray-600 dark:text-gray-400">{doc.label}</span>
                </div>
                {doc.url ? (
                    <a href={doc.url} target="_blank" rel="noreferrer" className="p-3 bg-black dark:bg-white text-club-primary dark:text-black rounded-xl hover:scale-110 transition-transform shadow-lg"><Download size={18} /></a>
                ) : (
      ...
      >
        {editingPlayer && (
          <form onSubmit={handleUpdatePlayer} className="space-y-8 max-h-[75vh] overflow-y-auto px-2 pb-6 custom-scrollbar">
            ...
            <div className="space-y-4">
               <div className="flex items-center gap-2 pb-2 border-b border-gray-100 dark:border-white/5">
                 <FileText className="w-4 h-4 text-club-primary" />
            ...
            <div className="pt-6 sticky bottom-0 bg-white dark:bg-[#1e293b] flex gap-3">
              ...
              <Button type="submit" isLoading={saving} className="flex-1 bg-club-primary text-black uppercase font-black tracking-widest text-[10px] italic h-14 rounded-2xl">
                Guardar Cambios
              </Button>
            </div>
          </form>
      ...
      {toast && (
        <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-bottom-10 duration-500">
           <div className={`flex items-center gap-3 px-6 py-4 rounded-3xl border shadow-2xl backdrop-blur-xl ${
             toast.type === 'success' ? 'bg-black/90 border-club-primary/20 text-white' : 'bg-red-500/90 border-red-500/20 text-white'
           }`}>
