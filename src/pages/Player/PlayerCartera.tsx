  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--primary)] p-8 rounded-[40px] flex items-center justify-between shadow-xl shadow-[var(--primary-10)] overflow-hidden relative group">
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        {charge.estado !== 'pagado' && charge.estado !== 'anulado' && charge.estado !== 'por validar' && (
                            <button 
                              ...
                              className="p-3 bg-[var(--primary)] text-black hover:bg-black hover:text-[var(--primary)] rounded-xl transition-all font-black uppercase text-[10px] tracking-widest flex items-center gap-2 border border-transparent hover:border-[var(--primary)]" 
                              title="Informar Pago"
                            >
            ...
            <div className="space-y-6">
                      ...
                      {approvingCharge.productos_eventos.link_pago && (
                        <div className="pt-2">
                          <a 
                            ...
                            target="_blank" 
                            rel="noreferrer"
                            className="flex items-center justify-center gap-2 w-full h-14 bg-[var(--primary)] text-black font-black uppercase text-xs tracking-widest rounded-2xl shadow-xl hover:scale-[1.02] transition-transform"
                          >
                  ...
                  <div className="p-6 bg-gray-50 dark:bg-white/5 rounded-3xl border border-gray-100 dark:border-white/10 relative overflow-hidden flex flex-col justify-center">
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center gap-2 mt-4">
                         ...
                         <p className="text-3xl font-black text-[var(--primary)] italic tabular-nums leading-none tracking-tighter">{formatCurrency(approvingCharge.monto, clubCurrency)}</p>
                      </div>
                    </div>
                  </div>
               ...
               <div className="space-y-4">
                  ...
                  <div className="relative group">
                     {previewUrl ? (
                        <div className="relative w-full aspect-video rounded-3xl overflow-hidden border-2 border-[var(--primary)] shadow-2xl">
                        ...
                        <label className="flex flex-col items-center justify-center w-full aspect-video bg-gray-50 dark:bg-[#111215] border-2 border-dashed border-gray-200 dark:border-white/10 rounded-3xl cursor-pointer hover:border-[var(--primary)] transition-all hover:bg-white/5">
               ...
               <div className="flex gap-4 pt-4">
                  ...
                  <Button 
                    className="flex-[2] h-16 bg-[var(--primary)] text-black rounded-2xl font-black uppercase text-xs italic tracking-widest gap-3 shadow-xl shadow-[var(--primary-20)] active:scale-95 transition-all" 
