  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
          <button onClick={() => navigate('/player/reservations')} className="p-3 bg-gray-100 dark:bg-white/5 hover:bg-[var(--primary)] hover:text-black rounded-xl transition-all border border-transparent dark:border-white/10">
             <ArrowLeft size={20} />
          </button>
          <div>
      ...
      <div className="bg-white dark:bg-[#16171b] border border-gray-100 dark:border-white/5 rounded-[40px] p-6 md:p-10 shadow-sm relative overflow-hidden">
              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-10">
                          ...
                          <div className="bg-gray-50 dark:bg-black/40 p-6 rounded-3xl border border-gray-200 dark:border-white/5 relative">
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                  ...
                                  <div className="bg-white dark:bg-white/5 p-3 rounded-2xl border border-gray-100 dark:border-transparent">
                                      ...
                                      <p className="text-xs font-black text-black dark:text-[var(--primary)] uppercase truncate">
                      ...
                      <div className="space-y-6">
                          ...
                          {escenarios.length > 0 ? (
                              <div className="space-y-4">
                                  ...
                                  {selectedEscenario && (
                                     <div className="p-4 bg-gray-100 dark:bg-[var(--primary-10)] border border-gray-200 dark:border-[var(--primary-20)] rounded-2xl mt-4 flex items-center gap-4 animate-in fade-in zoom-in-95">
                  ...
                  <div className="pt-6 flex justify-end border-t border-gray-100 dark:border-white/5">
                      <Button 
                          ...
                          onClick={() => setStep(2)}
                          className="bg-black dark:bg-[var(--primary)] text-white dark:text-black font-black uppercase italic px-10 h-14 rounded-2xl shadow-xl hover:scale-[1.02] transition-transform gap-3"
                      >
          ...
          {step === 4 && (
              <div className="py-20 text-center animate-in zoom-in-95 duration-700">
                  ...
                  <Button onClick={() => navigate('/player/reservations')} className="bg-black dark:bg-[var(--primary)] text-white dark:text-black hover:scale-[1.02] active:scale-95 font-black uppercase px-12 h-14 rounded-[24px] italic tracking-wider transition-all shadow-xl gap-2">
