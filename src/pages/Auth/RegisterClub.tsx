            ...
            {step === 1 && (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="pt-4 pb-2">
                  <button
                    type="submit"
                    className="group relative w-full flex items-center justify-center py-3.5 px-4 border border-transparent text-sm font-bold rounded-full text-white bg-[#182332] hover:text-club-primary hover:bg-[#202f43] focus:outline-none transition-all shadow-lg shadow-[#182332]/20"
                  >
            ...
            {step === 2 && (
              <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <button
                    type="submit"
                    className="flex-[2] flex items-center justify-center py-3.5 px-4 border border-transparent text-sm font-bold rounded-full text-white bg-[#182332] hover:text-club-primary hover:bg-[#202f43] focus:outline-none transition-all shadow-xl"
                  >
                    CONTINUAR <ArrowRight size={18} className="ml-2" />
                  </button>
                </div>
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="pt-4 flex gap-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="group relative flex-[2] flex justify-center py-3.5 px-4 border border-transparent text-sm font-bold rounded-full text-white bg-[#182332] hover:text-club-primary hover:bg-[#202f43] focus:outline-none transition-all disabled:opacity-70"
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl text-center animate-in zoom-in-95 duration-300">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 font-bold rounded-full text-white bg-[#182332] hover:text-club-primary hover:bg-[#202f43] focus:outline-none transition-all"
            >
              IR A INICIAR SESIÓN
            </button>
          </div>
