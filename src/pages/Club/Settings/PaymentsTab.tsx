  ...
  if (loading) {
    return (
      <div className="p-8 flex items-center justify-center min-h-[400px]">
        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-club-primary"></div>
      </div>
    );
  }
      ...
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className={`relative w-full bg-gray-50 border-2 border-dashed ${qrFile ? 'border-club-primary bg-club-primary/5' : 'border-gray-200 hover:border-gray-300'} rounded-2xl p-8 flex flex-col items-center justify-center min-h-[220px] transition-all group overflow-hidden`}>
               <input 
                 type="file" 
                 accept="image/*" 
              ...
              {previewUrl || formData.qr_url ? (
                <div className="text-center space-y-4 relative z-0">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {previewUrl && <p className="text-[9px] font-black text-club-primary mt-1 bg-black px-2 py-0.5 rounded-full uppercase tracking-widest">Listo para guardar</p>}
                  </div>
                </div>
              ) : (
                <div className="flex flex-col items-center text-center space-y-3 relative z-0">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                     <Upload className="w-5 h-5 text-gray-400 group-hover:text-club-primary transition-colors" />
                  </div>
                  <div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <textarea
              className="w-full bg-white border border-gray-300 rounded-2xl px-5 py-4 text-base text-gray-900 focus:ring-2 focus:ring-club-primary focus:border-transparent outline-none transition-all placeholder-gray-400 min-h-[140px] shadow-sm"
