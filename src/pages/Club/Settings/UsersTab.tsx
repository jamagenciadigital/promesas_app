    ...
    <div className="p-[1.2rem] space-y-6 pb-20 animate-in fade-in duration-500">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full h-11 bg-white border border-gray-200 rounded-2xl pl-10 pr-4 text-sm focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent outline-none text-gray-900 placeholder-gray-400 transition-all"
        />
      </div>
                  ...
                  {ROLES.filter(role => !activeModules || activeModules.includes(role.moduleKey)).map((role) => (
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {userForm.rol === role.value && <ShieldCheck className="w-4 h-4 text-[var(--primary)]" />}
                      </div>
