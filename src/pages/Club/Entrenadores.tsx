        ...
        <div className="flex items-center gap-3">
           <div className="relative">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2 bg-white dark:bg-[#1e293b]/50 border border-gray-100 dark:border-white/5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-[var(--primary)] min-w-[250px]"
              />
           </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           {filteredCoaches.map((coach) => (
             <div key={coach.id} className="group relative bg-white dark:bg-[#1e293b]/40 border border-gray-100 dark:border-white/5 rounded-[48px] p-8 shadow-sm hover:shadow-2xl transition-all overflow-hidden flex flex-col items-center">
                ...
                <div 
                  className="w-24 h-24 rounded-[32px] bg-gray-900 border-2 border-gray-100 dark:border-white/5 overflow-hidden flex items-center justify-center text-white dark:text-black text-3xl font-black italic shadow-lg mb-6 cursor-pointer hover:border-[var(--primary)] transition-all"
                ...
                >
                    {coach.foto_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center bg-gray-900 dark:bg-[var(--primary)]">
