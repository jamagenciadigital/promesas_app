...
export default function Calendar() {
      ...
      <div className="space-y-8 pb-20 animate-in fade-in duration-500">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
             ...
             <Button 
                className="bg-club-primary text-black h-12 rounded-2xl font-black uppercase italic text-[10px] tracking-widest px-8 shadow-lg shadow-club-primary/20"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-1 space-y-6">
            <div className="bg-white dark:bg-[#1e293b]/40 border border-gray-100 dark:border-white/5 rounded-[40px] p-8 space-y-6">
              <div className="bg-club-primary/5 p-6 rounded-3xl border border-club-primary/10 space-y-4">
                <div>
                ...
                {planningForEvent && planningForEvent.objetivos?.length > 0 && (
                  <div className="pt-4 border-t border-club-primary/10">
                    <p className="text-[10px] font-black text-club-primary uppercase mb-3 italic tracking-widest">Objetivos de la Sesión</p>
                    <div className="flex flex-col gap-2">
                      {planningForEvent.objetivos.map((obj: any, i: number) => (
                        <div key={i} className="bg-white/50 dark:bg-black/20 p-3 rounded-2xl border border-white/5 flex items-start gap-3">
                          <div className="w-5 h-5 rounded-full bg-club-primary flex items-center justify-center text-black text-[10px] font-bold flex-shrink-0">
                            {i + 1}
                          </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="bg-gray-50 dark:bg-black/20 p-4 rounded-3xl border border-transparent">
                    ...
                    <div className="flex items-center gap-3">
                      <p className="text-3xl font-black text-club-primary">
                      ...
                      <Trophy size={20} className="text-club-primary opacity-50" />
                    </div>
                  </div>
                  
                  {attendanceData.filter(a => a.estado === 'presente' && (a.puntaje_total || 0) > 0).length > 0 && (
                    <div className="bg-club-primary p-4 rounded-3xl border border-transparent shadow-lg shadow-club-primary/10">
              ...
              <div className="bg-gray-50 dark:bg-black/20 p-6 rounded-3xl space-y-3">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { v: 4, l: 'Muy Bueno', c: 'text-club-primary' },
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  ...
                  className="w-full bg-gray-50 dark:bg-black/20 border-none rounded-3xl p-5 text-xs font-medium focus:ring-2 focus:ring-club-primary dark:text-white min-h-[120px] transition-all"
          ...
          <div className="xl:col-span-2 space-y-4">
            {loadingAttendance ? (
              <div className="flex flex-col items-center justify-center py-24 gap-4 bg-white dark:bg-[#1e293b]/40 rounded-[40px] border border-gray-100 dark:border-white/5">
                <Loader2 className="w-10 h-10 animate-spin text-club-primary" />
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Cargando nómina de deportistas...</p>
              </div>
            ) : attendanceData.map((record, idx) => (
              <div key={record.deportista_id} className="bg-white dark:bg-[#1e293b]/40 border border-gray-100 dark:border-white/5 rounded-[40px] p-6 lg:p-8 space-y-6 transition-all hover:border-club-primary/30 group">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="h-2 w-32 bg-gray-200 dark:bg-white/10 rounded-full overflow-hidden">
                          <div 
                            className="h-full bg-club-primary transition-all duration-700" 
                            style={{ width: `${record.puntaje_total}%` }}
                          />
                        </div>
                        <span className="text-xl font-black text-club-primary italic">{record.puntaje_total}%</span>
                      </div>
                    </div>
                        ...
                        return (
                          <div key={objIdx} className="space-y-3">
                            <div className="flex justify-between items-center px-1">
                              ...
                              <span className="text-xs font-black text-club-primary">{currentScore}/5</span>
                            </div>
                              ...
                              {[1, 2, 3, 4, 5].map(score => (
                                <button
                                  ...
                                  className={cn(
                                    ...
                                    currentScore === score 
                                      ? "bg-club-primary border-club-primary text-black shadow-lg shadow-club-primary/10" 
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-gray-50 dark:bg-black/20 border-none rounded-2xl px-6 h-14 text-xs font-medium focus:ring-2 focus:ring-club-primary dark:text-white transition-all"
                    value={record.notas}
                    onChange={(e) => {
                      const newData = [...attendanceData];
          ...
          <button
            ...
            className={cn(
              ...
              isListening 
                ...
                : "bg-black dark:bg-white border-club-primary dark:border-black hover:scale-105"
            )}
            title="Asistente IA"
          >
            {isListening ? (
              ...
              <Bot size={28} className="text-club-primary dark:text-black" />
            )}
          </button>
          {isListening && (
  ...
  return (
    <div className="space-y-8 pb-20">
                 ...
                 <div className="space-y-2">
                    <button 
                      ...
                      className={cn(
                        ...
                        selectedTeam === '' ? "bg-club-primary/10 border-club-primary text-black dark:text-club-primary" : "bg-gray-50 dark:bg-white/5 border-transparent text-gray-500"
                      )}
                    >
                    ...
                    {teams.map(team => (
                      <button 
                        ...
                        className={cn(
                          "w-full flex items-center gap-3 p-4 rounded-2xl text-xs font-bold transition-all border",
                          selectedTeam === team.id ? "bg-club-primary/10 border-club-primary text-black dark:text-club-primary" : "bg-gray-50 dark:bg-white/5 border-transparent text-gray-500"
                        )}
                      >
                 ...
                 {calendarDays.map((day, idx) => {
                    ...
                    return (
                      <div 
                        ...
                        className={cn(
                          "min-h-[120px] p-4 rounded-3xl border transition-all hover:border-club-primary/50 group cursor-pointer",
        ...
        {selectedEvent && (
          <div className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-3xl space-y-2">
                   ...
                   <div className="flex items-center gap-2 text-gray-900 dark:text-white font-black italic">
                      {selectedEvent.invitados || selectedEvent.tipo === 'entrenamiento' ? (
                        <>
                          <Users size={16} className="text-club-primary" />
                          <Badge className="bg-club-primary text-black border-none text-[8px]">
             ...
             {selectedEvent.isJuego ? (
               <div className="bg-club-primary/5 rounded-[32px] p-8 border border-club-primary/10 space-y-6 my-6">
                 <h4 className="text-[10px] font-black text-club-primary uppercase tracking-widest italic">Jugadores Registrados</h4>
                 <div className="space-y-2">
                      ...
                      gamePlayers.map(p => (
                        <div key={p.id} className="flex justify-between items-center bg-white/5 p-4 rounded-2xl border border-white/10 shadow-sm hover:bg-white/10 transition-colors">
                          <div className="flex items-center gap-3 min-w-0">
                            <div className="w-8 h-8 rounded-full bg-club-primary flex items-center justify-center text-black text-[10px] font-black shrink-0">
                              {p.numero}
                            </div>
                            <span className="text-sm font-bold text-gray-900 dark:text-white truncate">{p.nombre}</span>
                          </div>
                          <div className="flex items-center gap-2">
                             <div className="h-1.5 w-1.5 rounded-full bg-club-primary animate-pulse" />
                             <span className="text-[10px] font-black text-club-primary uppercase tracking-widest italic">Convocado</span>
                          </div>
                        </div>
                      ))
                   )}
               ...
               <>
                 ...
                 <div className="bg-club-primary/5 rounded-[32px] p-8 border border-club-primary/10 space-y-6 my-6">
                   <div className="flex justify-between items-center border-b border-club-primary/10 pb-4">
                     <h4 className="text-[10px] font-black text-club-primary uppercase tracking-widest italic">Resumen de la Sesión</h4>
                     {eventStats && (eventStats.promedio || 0) > 0 && (
                       <div className="flex items-center gap-2">
                         <span className="text-[10px] font-black text-gray-400 uppercase italic">Promedio:</span>
                         <span className="text-sm font-black text-club-primary">{eventStats.promedio}%</span>
                       </div>
                     )}
                   </div>
                   ...
                   {/* MVP en el Pop-up */}
                   {eventStats?.mvp && (
                     <div className="pt-4 border-t border-club-primary/10 flex items-center justify-between">
                       <div className="flex items-center gap-3">
                         <div className="w-10 h-10 rounded-full bg-club-primary flex items-center justify-center text-black shadow-lg shadow-club-primary/20">
                           <Trophy size={20} />
                         </div>
                         <div>
                           <p className="text-[8px] font-black text-club-primary uppercase italic tracking-widest">MVP de la Sesión</p>
                       ...
                       <div className="text-right">
                         <p className="text-xl font-black text-club-primary italic leading-none">{eventStats.mvp.puntaje_total}%</p>
                 ...
                 <div className="flex flex-col gap-3">
                    <Button 
                       className="w-full bg-club-primary text-black rounded-2xl font-black uppercase italic text-[10px] tracking-widest gap-2 h-14"
      ...
      >
        <form onSubmit={handleSaveTraining} className="space-y-6">
           <div className="space-y-4">
              ...
              <input 
                className="w-full h-14 bg-gray-50 dark:bg-white/5 border-none rounded-2xl px-6 text-sm font-bold focus:ring-2 focus:ring-club-primary dark:text-white"
           ...
           <div className="space-y-4">
              ...
              <select 
                required
                className="w-full h-14 bg-gray-50 dark:bg-white/5 border-none rounded-2xl px-6 text-sm font-bold appearance-none focus:ring-2 focus:ring-club-primary dark:text-white"
           ...
           <div className="space-y-4">
              ...
              <textarea 
                className="w-full p-6 bg-gray-50 dark:bg-white/5 border-none rounded-3xl text-sm font-medium focus:ring-2 focus:ring-club-primary min-h-[100px] dark:text-white"
      ...
      >
        <form onSubmit={handleSaveEvent} className="space-y-6">
           ...
           <div className="space-y-4">
              ...
              <textarea 
                className="w-full p-6 bg-gray-50 dark:bg-white/5 border-none rounded-3xl text-sm font-medium focus:ring-2 focus:ring-club-primary min-h-[80px] dark:text-white"
            ...
            {eventForm.teamId && (
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                 <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest px-1 flex justify-between">
                   ...
                   <span className="text-club-primary font-bold">{eventForm.invitedPlayerIds.length} {t('calendar.selected')}</span>
                 </label>
                 <div className="bg-gray-50 dark:bg-white/5 rounded-3xl p-4 max-h-[220px] overflow-y-auto space-y-2 border border-transparent focus-within:border-club-primary/30 transition-all">
                   {fetchingPlayers ? (
                     <div className="flex items-center justify-center py-8">
                       <Loader2 className="w-6 h-6 animate-spin text-club-primary" />
                          ...
                          <div 
                           ...
                           className={cn(
                             ...
                             eventForm.invitedPlayerIds.includes(player.id)
                               ? "bg-club-primary/10 border-club-primary/30"
      ...
      >
        <div className="space-y-6">
          <div className="bg-club-primary/5 p-5 rounded-3xl border border-club-primary/10 flex flex-col gap-2">
             <div className="flex justify-between items-start">
               ...
               {planningForEvent && (
                 <span className="bg-club-primary text-black text-[8px] font-black px-2 py-1 rounded-full uppercase italic">Planificado</span>
               )}
             </div>

             {/* Objetivos Generales de la Sesión */}
             {planningForEvent && planningForEvent.objetivos?.length > 0 && (
               <div className="mt-3 pt-3 border-t border-club-primary/10">
                 <p className="text-[8px] font-black text-club-primary uppercase mb-2 italic">Objetivos de la Sesión:</p>
                ...
                <div key={record.deportista_id} className={cn(
                  ...
                  record.estado_pago !== 'pagado' ? "border-amber-500/30" : "border-gray-100 dark:border-white/5"
                   ...
                   {record.estado === 'presente' && planningForEvent && planningForEvent.objetivos?.length > 0 && (
                     <div className="bg-gray-50 dark:bg-black/20 rounded-2xl p-4 space-y-4 animate-in slide-in-from-top-2 border border-club-primary/10">
                        <div className="flex items-center justify-between mb-2">
                           ...
                           <div className="flex items-center gap-2">
                              <div className="h-1.5 w-24 bg-gray-200 dark:bg-white/10 rounded-full overflow-hidden">
                                 <div 
                                    className="h-full bg-club-primary transition-all duration-500" 
                                    style={{ width: `${record.puntaje_total}%` }}
                                 />
                              </div>
                              <span className="text-[10px] font-black text-club-primary">{record.puntaje_total}%</span>
                           </div>
                        </div>
                             ...
                             return (
                               <div key={objIdx} className="space-y-1">
                                  <div className="flex justify-between items-center">
                                     ...
                                     <span className="text-[9px] font-black text-club-primary">{currentScore}/5</span>
                                  </div>
                                     ...
                                     {[1, 2, 3, 4, 5].map(score => (
                                       <button
                                          ...
                                          className={cn(
                                            ...
                                            currentScore === score 
                                              ? "bg-club-primary text-black shadow-sm" 
                   ...
                   <input 
                    ...
                    className={cn(
                        "w-full bg-gray-50 dark:bg-black/10 border-none rounded-xl px-4 h-10 text-[11px] font-medium focus:ring-1 focus:ring-club-primary dark:text-white",
          ...
          <div className="flex gap-4 pt-4 border-t border-gray-100 dark:border-white/5">
            ...
            {profile?.rol === 'entrenador' && (
                <Button 
                    className="flex-1 bg-black text-white dark:bg-club-primary dark:text-black rounded-2xl font-black uppercase italic text-[10px] tracking-widest h-12"
                    onClick={handleSaveAttendance}
                    isLoading={saving}
                >
