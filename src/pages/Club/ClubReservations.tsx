    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
        ...
        <div className="flex bg-gray-100 dark:bg-white/5 p-1.5 rounded-2xl border border-gray-200 dark:border-white/10">
          {!isViewOnly && (
            <button
              ...
              className="px-6 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all bg-club-primary text-black shadow-lg hover:scale-105 mr-2"
            >
              Nueva Reserva
            </button>
          )}
          {(['todo', 'pendiente', 'confirmada'] as const).map((f) => (
            <button
              ...
              className={`px-6 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${
                filter === f 
                  ? 'bg-black dark:bg-club-primary text-white dark:text-black shadow-lg' 
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-4 bg-white dark:bg-[#16171b] border border-gray-100 dark:border-white/5 p-4 rounded-3xl">
        <div className="flex-1">
          <select
            ...
            className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-white outline-none focus:border-club-primary"
          >
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl pl-12 pr-4 py-3 text-sm text-gray-900 dark:text-white outline-none focus:border-club-primary"
          />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredReservations.map((res, idx) => (
            <div 
              ...
              className="cursor-pointer group bg-white dark:bg-[#16171b] border border-gray-100 dark:border-white/5 rounded-[40px] overflow-hidden hover:border-club-primary/30 transition-all duration-500 shadow-sm hover:shadow-2xl"
            >
              <div className="bg-black p-8 relative overflow-hidden">
                <div className="flex justify-between items-start relative z-10">
                  <div className="space-y-2">
                     <p className="text-[10px] font-black text-club-primary uppercase italic tracking-widest leading-none">Equipo: {res.equipos?.nombre || 'N/A'}</p>
                ...
                <div className="absolute top-0 right-0 w-32 h-32 bg-club-primary/10 rounded-full blur-[40px] -mr-16 -mt-16" />
              </div>
              
              <div className="p-8 space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                    <Calendar className="text-club-primary" size={16} />
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                    <Clock className="text-club-primary" size={16} />
                    <div className="text-left">
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-white/5 rounded-2xl">
                  <MapPin className="text-club-primary" size={16} />
                  <div className="text-left">
        ...
        <div className="bg-gray-50 dark:bg-white/5 border-2 border-dashed border-gray-200 dark:border-white/10 rounded-[64px] p-24 text-center">
          <div className="bg-club-primary/10 w-28 h-28 rounded-[40px] flex items-center justify-center mx-auto mb-8 shadow-inner">
            <CalendarDays className="w-12 h-12 text-club-primary" />
          </div>
          ...
          <div className="bg-white dark:bg-[#16171b] border border-gray-200 dark:border-white/10 rounded-[40px] max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative">
            ...
            <div className="p-8 md:p-10">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 bg-club-primary/20 rounded-2xl flex items-center justify-center">
                  <FileText className="text-club-primary w-8 h-8" />
                </div>
                <div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl border border-gray-100 dark:border-white/5 text-center">
                    ...
                    <p className="text-xs font-bold text-club-primary">${selectedRes.monto_total?.toLocaleString()}</p>
                  </div>
                </div>
                ...
                {selectedRes.link_pago && (
                  <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-3xl border border-gray-100 dark:border-white/5 flex justify-between items-center">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noreferrer"
                      className="px-4 py-2 bg-club-primary text-black text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-white transition-colors"
                    >
                      Ver Comprobante
                    </a>
                  </div>
