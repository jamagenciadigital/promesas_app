    ...
    <div className="space-y-6 pb-20 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 bg-[#182332] px-4 py-2 rounded-full">
          ...
          <span className="text-[11px] font-semibold text-[var(--primary)]">{admins.length} Usuarios</span>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative min-w-[200px]">
          ...
          <select
            ...
            className="w-full h-11 bg-white border border-gray-200 rounded-2xl pl-11 pr-4 text-sm font-medium focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent outline-none text-gray-900 appearance-none cursor-pointer"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm font-medium text-gray-900 placeholder-gray-400 outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent transition-all disabled:bg-gray-100 disabled:text-gray-400"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm font-medium outline-none focus:ring-2 focus:ring-[var(--primary)] focus:border-transparent text-gray-900 appearance-none cursor-pointer"
                >
