      ...
      <div className="w-full max-w-xl bg-white rounded-[48px] shadow-2xl shadow-black/5 border border-gray-100 overflow-hidden relative z-10 animate-in fade-in zoom-in-95 duration-700">
        ...
        {typeof step === 'number' && (
          <div className="flex bg-gray-100 h-1.5 w-full">
            <div className={`h-full bg-[var(--primary)] transition-all duration-500 ${step === 0 ? 'w-1/3' : step === 1 ? 'w-2/3' : 'w-full'}`}></div>
          </div>
        )}
        ...
        <div className="p-10 md:p-14 space-y-8">
          ...
          {step === 0 && (
            <div className="space-y-6 animate-in slide-in-from-bottom-4">
               ...
               <Button onClick={nextStep} isLoading={validatingCode} className="w-full h-16 bg-black text-[var(--primary)] rounded-2xl font-black uppercase italic tracking-widest shadow-xl flex items-center justify-center gap-2">
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4">
               <div className="flex items-center gap-4 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="text-[8px] font-black text-[var(--primary)] uppercase tracking-widest">Equipo Encontrado</p>
               ...
               <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full h-14 pl-12 pr-4 bg-gray-50 rounded-2xl border border-transparent focus:border-[var(--primary)] outline-none transition-all text-sm"
                    value={searchTerm}
               ...
               <div className="max-h-[250px] overflow-y-auto space-y-2 pr-2 custom-scrollbar">
                  {filteredPlayers.map(p => (
                    <button 
                      ...
                      className={`w-full flex items-center justify-between p-4 rounded-2xl border transition-all ${selectedPlayer?.id === p.id ? 'bg-black border-black text-[var(--primary)]' : 'bg-white border-gray-100 text-gray-900 hover:border-[var(--primary)]'}`}
                    >
               ...
               <Button onClick={nextStep} className="w-full h-16 bg-[var(--primary)] text-black rounded-2xl font-black uppercase italic tracking-widest shadow-xl flex items-center justify-center gap-2">
          ...
          {step === 2 && (
            <div className="space-y-6 animate-in slide-in-from-right-4">
               ...
               <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <Button type="submit" isLoading={loading} className="w-full h-16 bg-black text-[var(--primary)] rounded-2xl font-black uppercase italic tracking-widest shadow-xl flex items-center justify-center gap-2 mt-4">
          ...
          {step === 'success' && (
            <div className="text-center space-y-8 animate-in zoom-in-95 duration-700">
               <div className="w-24 h-24 bg-[var(--primary)] rounded-full flex items-center justify-center mx-auto shadow-2xl shadow-[var(--primary-40)]">
               ...
               <Button onClick={() => window.location.href = '/login'} className="w-full h-16 bg-black text-[var(--primary)] rounded-2xl font-black uppercase italic tracking-widest shadow-xl">
                 Ir al Login
               </Button>
            </div>
          )}
