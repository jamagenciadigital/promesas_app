        ...
        <div className="w-full max-w-2xl mx-auto space-y-8">
            ...
            <div className="text-left animate-in fade-in duration-700 space-y-4">
              {teamInfo?.club && (
                <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 rounded-3xl border border-gray-100 max-w-fit">
                  {teamInfo.club.logo_url ? <img src={getDirectImageUrl(teamInfo.club.logo_url)} className="w-12 h-12 rounded-2xl object-cover" /> : <div className="w-12 h-12 rounded-2xl bg-club-primary/10 flex items-center justify-center"><Shield className="w-6 h-6 text-club-primary" /></div>}
                  <div>
              ...
              {teamInfo && (
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 p-6 bg-white/50 rounded-[32px] border border-gray-50 backdrop-blur-sm shadow-sm border-l-4 border-l-club-primary animate-in slide-in-from-top-4 duration-500">
                  <div className="space-y-1">
                    <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">NIVEL</p>
                    <div className="flex items-center gap-1.5">
                      <Trophy className="w-3 h-3 text-club-primary" />
                  ...
                  {teamInfo.sede?.nombre && (
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        <MapPin className="w-3 h-3 text-club-primary" />
                  ...
                  {teamInfo.dias_entrenamiento && teamInfo.dias_entrenamiento.length > 0 && (
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Calendar className="w-3 h-3 text-club-primary" />
                  ...
                  {(teamInfo.hora_inicio || teamInfo.hora_fin) && (
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Clock className="w-3 h-3 text-club-primary" />
                  ...
                  {teamInfo.entrenadores && teamInfo.entrenadores.length > 0 && (
                    <div className="space-y-1 col-span-2">
                      ...
                      <div className="flex items-center gap-1.5">
                        <User className="w-3 h-3 text-club-primary" />
                        <span className="text-[10px] font-black uppercase tracking-tighter text-gray-700 italic">
              ...
              {typeof step === 'number' && step > 0 && (
                <div className="flex gap-1 h-1 w-full max-w-xs bg-gray-100 rounded-full overflow-hidden print:hidden">
                  {[1,2,3,4,5,6,7].map(s => (
                    <div key={s} className={`flex-1 transition-all duration-500 ${step >= s ? 'bg-club-primary' : 'bg-transparent'}`}></div>
                  ))}
                </div>
              )}
            </div>
          ...
          {step === 0 && (
             <div className="space-y-6">
               <div className="bg-white p-8 rounded-[40px] shadow-2xl shadow-black/5 border border-gray-50">
                 ...
                 <Button onClick={nextStep} isLoading={validatingCode} className="w-full h-16 bg-black text-club-primary font-black uppercase italic tracking-widest rounded-3xl mt-8 shadow-xl text-sm gap-2">Verificar <ChevronRight size={20} /></Button>
               </div>
             </div>
          )}
            ...
            <form onSubmit={handleRegister} className="space-y-8">
                ...
                <div className="space-y-8 animate-in fade-in">
                  ...
                  <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-[32px] border border-gray-100 dark:border-white/5">
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${formData.viene_de_otro_club ? 'bg-black text-club-primary' : 'bg-white dark:bg-white/5 text-gray-400 group-hover:border-club-primary border border-transparent'}`}>
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <Button type="button" onClick={nextStep} className="flex-[2] h-14 bg-black text-club-primary font-black uppercase text-xs rounded-3xl shadow-xl">Continuar <ChevronRight size={16} /></Button>
                  </div>
                </div>
              )}
              ...
              {step === 2 && (
                <div className="space-y-8 animate-in fade-in">
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <Button type="button" onClick={nextStep} className="flex-[2] h-14 bg-black text-club-primary font-black uppercase text-xs rounded-3xl shadow-xl">Siguiente <ChevronRight size={16} /></Button>
                  </div>
                </div>
              )}
              ...
              {step === 5 && (
                <div className="space-y-8 animate-in fade-in">
                  <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          {inscripcionPlans.map(p => (
                            <button key={p.id} type="button" onClick={() => setFormData({ ...formData, plan_inscripcion_id: p.id })} className={`flex items-center justify-between p-6 rounded-3xl border-2 transition-all ${formData.plan_inscripcion_id === p.id ? 'bg-black border-black text-club-primary' : 'bg-gray-50 border-transparent text-gray-900 font-bold'}`}>
                    ...
                    {regularPlans.length > 0 && (
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                          {regularPlans.map(p => (
                            <button key={p.id} type="button" onClick={() => setFormData({ ...formData, plan_id: p.id })} className={`flex items-center justify-between p-6 rounded-3xl border-2 transition-all ${formData.plan_id === p.id ? 'bg-black border-black text-club-primary' : 'bg-gray-50 border-transparent text-gray-900 font-bold'}`}>
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <Button type="button" onClick={nextStep} className="flex-[2] h-16 bg-black text-club-primary font-black uppercase text-xs rounded-3xl shadow-xl">Revisar Contrato <ChevronRight size={16} /></Button>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-8 animate-in fade-in">
                  ...
                  <div className="print:hidden space-y-6">
                    ...
                    <label className="flex items-start gap-3 cursor-pointer p-6 bg-gray-50 rounded-[32px] border border-gray-100 hover:bg-gray-100 transition-colors">
                      <input type="checkbox" required checked={formData.acepta_terminos} onChange={e => setFormData({...formData, acepta_terminos: e.target.checked})} className="mt-1 h-5 w-5 rounded border-gray-300 text-black focus:ring-club-primary" />
                    ...
                    <div className="flex gap-4 pt-4">
                      <Button type="button" variant="ghost" onClick={prevStep} className="flex-1 h-14 font-black uppercase text-[10px]">Anterior</Button>
                      <Button type="button" onClick={nextStep} className="flex-[2] h-14 bg-black text-club-primary font-black uppercase text-xs rounded-3xl shadow-xl">Siguiente: Documentos <ChevronRight size={16} /></Button>
                    </div>
                  </div>
                </div>
              )}
              ...
              {step === 7 && (
                <div className="space-y-8 animate-in fade-in">
                  ...
                  <div className="flex gap-4 pt-4">
                    <Button type="button" variant="ghost" onClick={prevStep} className="flex-1 h-16 font-black uppercase text-[10px]">Anterior</Button>
                    <Button type="submit" isLoading={loading} className="flex-[2] h-16 bg-club-primary text-black font-black uppercase italic tracking-widest text-xs rounded-[32px] shadow-2xl shadow-club-primary/20">Finalizar Registro</Button>
                  </div>
                </div>
              )}
            </form>
          ...
          {step === 'success' && (
            <div className="text-center space-y-10 animate-in zoom-in-95">
               <div className="w-24 h-24 bg-club-primary rounded-full flex items-center justify-center mx-auto shadow-2xl shadow-club-primary/30"><CheckCircle2 size={48} className="text-black" /></div>
               <div className="space-y-4">
               ...
               <Button onClick={() => window.location.reload()} className="h-16 px-12 bg-black text-club-primary rounded-3xl font-black uppercase italic tracking-widest shadow-2xl">Entendido</Button>
            </div>
          )}
        </div>
      </div>
