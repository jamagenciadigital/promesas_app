    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white/5 border border-white/5 p-8 rounded-[40px] space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-black text-white uppercase italic tracking-tight flex items-center gap-3">
                  <MessageSquare className="text-club-primary" />
            ...
            {pqrs.adjunto_url && (
              ...
              >
                <div className="p-2 bg-black rounded-xl text-gray-400 group-hover:text-club-primary">
                  <Paperclip size={18} />
                </div>
          ...
          {(pqrs.respuesta || isDestinatario) && (
            <div className={`p-8 rounded-[40px] border-2 space-y-6 ${pqrs.respuesta && pqrs.estado !== 'en_revision' ? 'bg-white/5 border-transparent' : 'bg-club-primary/5 border-club-primary/20'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Send className="text-club-primary" size={20} />
              ...
              {isDestinatario && (pqrs.estado === 'pendiente' || pqrs.estado === 'en_revision') && (
                <div className="space-y-4 pt-4 border-t border-white/5">
                  <textarea
                    ...
                    className="w-full bg-black/40 border-2 border-transparent focus:border-club-primary/40 rounded-3xl p-6 text-sm text-white outline-none min-h-[150px] resize-none transition-all"
                  />
                  <Button
                    onClick={handleResponder}
                    isLoading={loading}
                    className="w-full h-14 bg-club-primary text-black font-black uppercase italic tracking-widest text-xs rounded-2xl"
                  >
          ...
          {pqrs.estado === 'respondida' && isOwner && !pqrs.feedback_usuario && (
            <div className="p-8 bg-black border-2 border-club-primary/20 rounded-[40px] space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-club-primary/5 border border-club-primary/10 p-6 rounded-[32px] space-y-4">
