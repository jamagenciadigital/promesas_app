...
export default function NotificationPopover() {
  ...
  const getIcon = (tipo: string) => {
    switch (tipo) {
      case 'invitacion': return <Calendar className="w-4 h-4 text-club-primary" />;
          ...
          <div className="px-6 py-2 border-b border-gray-100 dark:border-white/5 flex justify-between items-center bg-gray-50/50 dark:bg-white/5 mx-2 rounded-2xl mb-2">
            ...
            {unreadCount > 0 && (
              <button 
                ...
                className="text-[9px] font-bold text-club-primary uppercase tracking-widest hover:underline transition-all"
              >
