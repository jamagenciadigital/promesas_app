  ...
  return (
    <div className={`space-y-2 ${className}`}>
      <div className="flex items-center justify-between px-1">
        ...
        {value && (
          <a href={value} target="_blank" rel="noreferrer" className="text-[9px] font-black text-club-primary uppercase underline italic">
            Ver Actual
          </a>
        )}
      </div>
        ...
        <div className={`flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-[#111215] border-2 transition-all ${
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-10 px-4 rounded-xl bg-black dark:bg-white text-club-primary dark:text-black font-black uppercase text-[9px] tracking-widest italic hover:scale-105 transition-transform"
              disabled={uploading}
            >
